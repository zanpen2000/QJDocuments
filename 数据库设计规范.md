...
| 郭阳 | 1.0.1 | 2019.05.16 | 更新“项目管理”及“自定义HTTP状态码”连接 |
| 张鹏 | 1.1.0 | 2019.6.6 | 增加字段类型设置原则和数据库设计原则 |
| 张鹏 | 1.1.1 | 2019.6.21 | 增加字段类型设置原则和数据库设计原则 |
...
3. 索引类原则
  ...
  - 不用外键(由程序保证约束)
  - update 语句 where 条件后的字段必须设置索引, 避免执行时造成锁表.
4. sql类原则
